...
void Initialize() {
    ...
    deadSound = Mix_LoadWAV("deadsound2.mp3");
...
void Render() {
    ...
    if (currentScene->state.player->gameOver) {
        ...
        Util::DrawText(&program, fontTextureID, "You Lose!", 1, -0.5f, glm::vec3(currentScene->state.player->position.x, currentScene->state.player->position.y, 0));
